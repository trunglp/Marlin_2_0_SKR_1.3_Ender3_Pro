...
//lptrung
#define STRING_CONFIG_H_AUTHOR "SKR V1.3 LPT" // Who made the changes.
 ...
 * :[-1, 0, 1, 2, 3, 4, 5, 6, 7]
 */
//lptrung on Set the serial port (first on USB, second the onboard):
...
//lptrung nghien cuu set #define HEATER_0_MAXTEMP 255
...
//lptrung nghien cuu set #define BED_MAXTEMP      110
//===========================================================================
//============================= PID Settings ================================
//===========================================================================
 ...
 */
//lptrung nghien cuu cho nay https://www.youtube.com/watch?v=duNHOPlh2Pg 17:30
 ...
 */
// lptrung mo tinh nang nay giup cho motor chay muot, it bi co giat, toc do van khong thay doi
...
//lptrung nghien cuu cho nay
// cho nay mo de dinh nghia BLTOUCH
 ...
 *
 */
//lptrung cho nay dinh nghia pin tren board
 ...
 */
//lptrung nghien cuu cho nay
// lptrung set on  https://www.youtube.com/watch?v=ONpKxkil16Q muc 2:14
...
//lptrung nghien cuu cho nay 200*60
...
//lptrung nghien cuu cho nay
//Tech mo truc z thanh true https://www.youtube.com/watch?time_continue=540&v=LNdMYgwez8Y
//Phut 8:54
...
///lptrung nghien cuu set hop ly tranh de Z qua cao
...
#define MAX_SOFTWARE_ENDSTOPS
  ...
  //lptrung nghien cuu cho nay  // Disable Soft Endstop for Z to make BLTouch calibration easier.
...
// Homing speeds (mm/m)
//lptrung set  //#define HOMING_FEEDRATE_XY (20*60)
...
//
//lptrung nghien cuu
//https://www.youtube.com/watch?time_continue=540&v=LNdMYgwez8Y
// Theo Teaching Tech phut thu 9:00 tam mo len neu muon dung LCD mac dinh cua ender 3
// Tam dung CR10 display
